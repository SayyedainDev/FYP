    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Upload your lecture notes (any file type supported)',
                ...
                children: [
                  ...
                  Text(
                    quizProvider.uploadedFileName != null
                        ...
                        : 'Supported formats: All file types (Max 10MB)',
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Quiz saved! View it in your quiz list.'),
  ...
  Future<void> _pickFile(
    ...
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        debugPrint('📏 File size: ${pickedFile.size} bytes');
        ...
        if (kIsWeb) {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('✅ $fileName saved to temporary storage'),
                backgroundColor: Colors.green,
          ...
          if (pickedFile.path != null) {
            ...
            if (mounted) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    '✅ Saved to temp: ${context.read<QuizProvider>().tempPath ?? file.path}',
                  ),
                  backgroundColor: Colors.green,
                  duration: const Duration(seconds: 2),
                ),
